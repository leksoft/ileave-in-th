...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>Main/UserIndex?role=<?php echo $role; ?>"><i class="fa fa-dashboard"></i> Home</a></li>
...
<section class="content">
    <div class="row">
        <?php echo form_open_multipart('Main/UserSave', array('role' => 'form', 'id' => 'myform')); ?>
        <div class="col-md-6">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <?php if ($this->uri->segment(2) == "UserEdit") : ?>
