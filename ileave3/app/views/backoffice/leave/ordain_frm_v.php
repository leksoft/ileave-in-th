                    ...
                    <div class="col-md-6">
                        <div class="box box-success">
                            ...
                            <div class="form-group">
                                ...
                                <textarea cols="3" rows="3" class="form-control"  id="comment" name ="comment"></textarea>
                            ...
                            <div class="form-group">
                                <label>ขอลาตั้งแต่วันที่<span class="required">*</span></label>
                            ...
                            <div class="form-group">
                                <label>ข้าพเจ้า<span class="required">*</span></label>

                                <label>
                                    <input type="radio" name="ordain_status" value="0" class="minimal-red"> ไม่เคยอุปสมบท
                                </label>
                                <label>
                                    <input type="radio" name="ordain_status" value="1" class="minimal-red"> เคยอุปสมบท
                                </label>

                            </div>
                            <div class="form-group">
                                <label>อุปสมบท ณ วัด/ตั้งอยู่ ณ <span class="required">*</span></label>

                                <textarea cols="3" rows="3"  id="measure_address" class="form-control required" name ="measure_address"></textarea>

                            </div>
                            <div class="form-group">
                                <label>กำหนดอุปสมบทวันที่ <span class="required">*</span></label>

                                <input class="form-control required" id="dateofordination" type="text" name ="dateofordination" value="">

                            </div>
                            <div class="form-group">
                                <label>จะจำพรรษาอยู่ ณ วัด <span class="required">*</span></label>

                                <textarea cols="3" rows="3"  id="temple_address" class="form-control required" name ="temple_address"></textarea>
