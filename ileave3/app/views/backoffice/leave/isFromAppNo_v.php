        ...
        <div class="col-md-9">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <?php echo form_open('Formleave/isNotApproveNo', array('class' => 'form-horizontal')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="comment_detail" name ="comment_detail" placeholder="หมายเหตุถ้าไม่อนุมัติให้ลา"></textarea>
                        </div>
                    </div>
