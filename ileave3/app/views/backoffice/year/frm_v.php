    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <!-- form start -->
                    <?php echo form_open('Main/YearSave', array('role' => 'form','id'=>'myform')); ?>
                     <input type="hidden" id="id" name="id" value="<?php echo @$row['id']; ?>"/>
                    <div class="box-body">
                        <div class="form-group">
                            <label for="">ปีงบประมาณ</label>
                            <input type="text" class="form-control required" id="" name ="name" placeholder="ปีงบประมาณ" value="<?php echo @$row['name']; ?>">
                        </div>
