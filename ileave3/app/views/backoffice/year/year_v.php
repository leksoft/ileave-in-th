...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>Main/YearIndex"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <div class="btn-group">
                        <a href ="<?php echo base_url('Main/YearAdd'); ?>">
                            <button type="button" class="btn btn-flat btn-google">
                                <i class="fa fa-plus-circle"></i> เพิ่มปีงบประมาณ
                            </button>
                        </a>
                    </div>
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover" id="">
                        ...
                        foreach ($query as $r) {
                            ...
                            echo '<a href="' . base_url('Main/YearEdit?id=' . $id) . '" class="btn btn-sm btn-default"><i class="fa fa-pencil"></i></a>&nbsp;';
