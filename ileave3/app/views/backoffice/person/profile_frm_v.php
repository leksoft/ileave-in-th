...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>Profile/PersonIndex?id=<?php echo $person_id;?>"><i class="fa fa-dashboard"></i> Home</a></li>
...
<section class="content">
    <div class="row">
    <?php echo form_open_multipart('Profile/PersonSave', array('role' => 'form', 'id' => 'myform')); ?>
        <div class="col-md-6">
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" id="id" name="id" value="<?php echo $person_id;?>"/>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <?php if ($this->uri->segment(2) == "PersonIndex") : ?>
                        ...
                        <div style="text-align:center">
                            <div class="fileinput fileinput-new" data-provides="fileinput" style="margin-left:5px;">
                                <div class="fileinput-new thumbnail">
                                    ...
                                    <?php else : ?>
                                        <img src="<?php echo base_url(); ?>assets/upload/person/<?php echo @$row['picture']; ?>" alt="ภาพประจำตัว" class="img-responsive">
                                    <?php endif; ?>
                                </div>
