...
<section class="content">
    <div class="row">
        <?php echo form_open_multipart('Main/PersonSave', array('role' => 'form', 'id' => 'myform')); ?>
        <div class="col-md-6">
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" id="role_id" name="role_id" value="<?php echo $role ?>"/>
                    <div class="box-body">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <?php if ($this->uri->segment(2) == "PersonEdit") : ?>
