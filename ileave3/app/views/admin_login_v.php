    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <?php echo form_open('Home/AdminAuthen', array('id' => 'myform')); ?>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <a href ="<?php echo base_url('Home/UserIndex'); ?>" class="btn bg-gray btn-flat">สำหรับผู้ลา</a>
                    </div>
                    <!-- /.col -->
                    <div class="col-xs-4">
                ...
                <a href="<?php echo base_url('Home/Register'); ?>" class="text-center">ลงทะเบียนใช้งานสำหรับผู้ลา</a>
